...
class Asteroid (CircleShape):
    ...
    def split(self):
        ...
        new_asteroid_1 = Asteroid(self.position.x, self.position.y, new_asteroids_radius)
        new_asteroid_1.velocity = new_velocity_1 * 1.2
        new_asteroid_2 = Asteroid(self.position.x, self.position.y, new_asteroids_radius)
